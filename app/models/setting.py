...
class Setting(models.Model):
    app_name = models.CharField(default='橙黄橘绿', max_length=255, blank=False, null=False, help_text=_("The name of your application"), verbose_name=_("App name"))
    ...
    organization_name = models.CharField(default='橙黄橘绿', max_length=255, blank=True, null=True, help_text=_("The name of your organization"), verbose_name=_("Organization name"))
    organization_website = models.URLField(default='https://space-docs.natsuu.top/', max_length=255, blank=True, null=True, help_text=_("The website URL of your organization"), verbose_name=_("Organization website"))
